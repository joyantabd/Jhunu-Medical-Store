    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form action="login.php" method="post">
          ...
          <button type="submit" class="btn btn-primary btn-block btn-flat" name="login" onclick="window.location.href='admin/index.php'" default>Sign In For Admin</button>
